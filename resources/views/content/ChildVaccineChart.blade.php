...
@section('content')
    ...
    {{-- button --}}
    <br>
    @if (auth()->user()->role == 'admin' && count($childs)<5)
                ...
                <form class="container bg-light" method="POST" action="{{ route('ChildVaccineChart.create') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group text-dark">
                            ...
                            <input type="text" class="form-control" name="V_Name" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter Vaccine Name">

                        </div>
                        <div class="form-group text-dark">
                            <label for="exampleInputEmail3">Disease</label>
                            <input type="text" class="form-control" name="disease" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter number of doses">

                        </div>
                        <div class="form-group text-dark">
                            <label for="exampleInputEmail3">Number of Doses</label>
                            <input type="number" class="form-control" name="N_of_dose" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter number of doses">

                        </div>
                        <div class="form-group text-dark">
                            <label for="exampleInputEmail3">Time Differences</label>
                            <input type="number" class="form-control" name="Time_difference" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter time difference in weeks">
                        ...
                        <div class="form-group text-dark">
                            ...
                            <input type="text" class="form-control" name="starting_time" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="On birth weeks">
