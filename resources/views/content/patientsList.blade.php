...
@section('content')
    ...
    <div class="row">
        ...
        @if (isset($search))
            <p>
                <span class="alert alert-success"> you are searching for '{{ $search }}' , found
                    ({{ count($patients) }})</span>
            </p>
        @endif
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('registration.patient') }}" class="container">
                    ...
                    <div class="modal-body bg-dark">
                        ...
                        <div class="mb-3">
                          <label class="form-label">* Default Password: epi2021</label>
                            ...
                            <td>
                                @if ($data->category == 'Child')
                                    <a class="btn btn-success"
                                        href="{{ route('patientsList.checkChild', $data['id']) }}">Check</a>
                                @elseif ($data->category == 'Teenage')
                                    <a class="btn btn-success"
                                        href="{{ route('patientsList.checkTeenge', $data['id']) }}">Check</a>
                                @else
